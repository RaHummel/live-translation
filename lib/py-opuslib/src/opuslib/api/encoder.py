...
libopus_create.argtypes = (ctypes.c_int, ctypes.c_int, ctypes.c_int, opuslib.api.c_int_pointer)
...
def create_state(fs: int, channels: int, application: int) -> ctypes.Structure:
    ...
    result = libopus_create(fs, channels, application, ctypes.byref(result_code))
...
libopus_encode.argtypes = (EncoderPointer, opuslib.api.c_int16_pointer, ctypes.c_int, ctypes.c_char_p, ctypes.c_int32)
...
def encode(
    ...
    result = libopus_encode(encoder_state, pcm_pointer, frame_size, opus_data, max_data_bytes)
...
def encode_float(
    ...
    result = libopus_encode_float(encoder_state, pcm_pointer, frame_size, opus_data, max_data_bytes)

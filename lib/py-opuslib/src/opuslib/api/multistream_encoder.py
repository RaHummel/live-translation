...
def create_state(
    fs: int, channels: int, streams: int, coupled_streams: int, mapping: list, application: int
) -> ctypes.Structure:
    ...
    encoder_state = libopus_create(
        fs, channels, streams, coupled_streams, _umapping, application, ctypes.byref(result_code)
    )
...
def encode(
    ...
    result = libopus_multistream_encode(encoder_state, pcm_pointer, frame_size, opus_data, max_data_bytes)
...
def encode_float(
    ...
    result = libopus_multistream_encode_float(encoder_state, pcm_pointer, frame_size, opus_data, max_data_bytes)

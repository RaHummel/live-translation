...
def create_state(fs: int, channels: int, streams: int, coupled_streams: int, mapping: list) -> ctypes.Structure:
    """
    ...
    decoder_state = libopus_create(fs, channels, streams, coupled_streams, _umapping, ctypes.byref(result_code))

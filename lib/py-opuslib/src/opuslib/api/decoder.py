...
libopus_create.argtypes = (ctypes.c_int, ctypes.c_int, opuslib.api.c_int_pointer)
...
def create_state(fs: int, channels: int) -> ctypes.Structure:
    ...
    decoder_state = libopus_create(fs, channels, ctypes.byref(result_code))
...
# FIXME: Remove typing.Any once we have a stub for ctypes
def packet_get_nb_frames(data: bytes, length: typing.Optional[int] = None) -> typing.Union[int, typing.Any]:
...
libopus_packet_get_samples_per_frame = opuslib.api.libopus.opus_packet_get_samples_per_frame
...
# FIXME: Remove typing.Any once we have a stub for ctypes
def packet_get_samples_per_frame(data: bytes, fs: int) -> typing.Union[int, typing.Any]:
...
libopus_get_nb_samples.argtypes = (DecoderPointer, ctypes.c_char_p, ctypes.c_int32)
libopus_get_nb_samples.restype = ctypes.c_int


# FIXME: Remove typing.Any once we have a stub for ctypes
def get_nb_samples(decoder_state: ctypes.Structure, packet: bytes, length: int) -> typing.Union[int, typing.Any]:
    """
...
def decode(  # pylint: disable=too-many-arguments
    decoder_state: ctypes.Structure, opus_data: bytes, length: int, frame_size: int, decode_fec: bool, channels: int = 2
    ...
    result = libopus_decode(decoder_state, opus_data, length, pcm_pointer, frame_size, _decode_fec)
...
def decode_float(  # pylint: disable=too-many-arguments
    ...
    result = libopus_decode_float(decoder_state, opus_data, length, pcm_pointer, frame_size, _decode_fec)
...
# FIXME: Remove typing.Any once we have a stub for ctypes
def decoder_ctl(decoder_state: ctypes.Structure, request, value=None) -> typing.Union[int, typing.Any]:
